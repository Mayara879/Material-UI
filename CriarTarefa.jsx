        ...
        <CardContent sx={{
          ...
          <Grid item xs={12}>
            <FormControl fullWidth>
              ...
              <FormHelperText id="tarefa_titulo_helper_text">Idade</FormHelperText>
            </FormControl>
          </Grid>
          <Grid item xs={12}>  
            <FormControl fullWidth>
              ...
              <FormHelperText id="tarefa_descricao_helper_text">Nome.</FormHelperText>
            </FormControl>
          </Grid>
          <Grid container spacing={2} mt={1}>
            ...
            <Grid item xs={3}>  
              <FormControl fullWidth>
                <InputLabel htmlFor="tarefa_aluno">Recurso</InputLabel>
                <Select
                  id="tarefa_recurso"
                  value={recursoTarefa}
                  label="Aluno"
                ...
                >
                  <MenuItem value={'Aluno 1'}>Recurso 1</MenuItem>
                  <MenuItem value={'Aluno 2'}>Recurso 2</MenuItem>
                  <MenuItem value={'Aluno 3'}>Recurso 3</MenuItem>
                </Select>
              </FormControl>
            </Grid>
            <Grid item xs={3}>  
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value={'Encerrado'}>Aguardando</MenuItem>
            ...
            <Grid container spacing={2} pl={2} mt={2}>
              <Grid item xs={1}>
                <Button size="medium" variant="contained" onClick={handleSalvar}>SIM</Button>
              </Grid>  
              <Grid item xs={1}>  
                <Button size="medim" variant="outlined" onClick={handleClose}>NÂO</Button> 
                <Grid item xs = {1}>
                  <Button size="big" variant="outlined" onClick={handleClose}>Entre em contato com o nosso time </Button> 
                  </Grid> 
              </Grid>
            </Grid>  
          </Grid>
