...
const initialRows = [
  createData(1, 'Mayara', 'Matematica', '2022-01-01', '2022-01-02', 'Concluída', 'Recurso 1'),
  createData(2, 'Joana', 'Qumica', '2022-01-03', '2022-01-04', 'Em Andamento', 'Recurso 2'),
  createData(3, 'Maria', 'Biologia', '2022-01-04', '2022-01-05', 'Em Andamento', 'Recurso 3'),
  createData(4, 'Rafael', 'Portugues', '2022-01-05', '2022-01-06', 'Em Andamento', 'Recurso 4'),
  createData(5, 'Luiz', 'Filosofia', '2022-01-06', '2022-01-07', 'Em Andamento', 'Recurso 5'),
  createData(6, 'Carvalho', 'Sociologia', '2022-01-07', '2022-01-08', 'Aguardando', 'Recurso 6'),
];
